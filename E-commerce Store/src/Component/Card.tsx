    ...
    <>
      <section className="flex justify-between px-2 md:px-16 py-5 pt-5">
        ...
        <ul className="flex gap-6 font-semibold text-gray-500">
          <li>
            <button
              className={`active:text-red-500 ${selectedCategory === "All" ? "text-red-500" : ""}`}
          ...
          <li>
            <button
              className={`active:text-red-500 ${selectedCategory === "Beauty" ? "text-red-500" : ""}`}
          ...
          <li>
            <button
              className={`active:text-red-500 ${selectedCategory === "Fragrances" ? "text-red-500" : ""}`}
          ...
          <li>
            <button
              className={`active:text-red-500 ${selectedCategory === "Furniture" ? "text-red-500" : ""}`}
          ...
          <li>
            <button
              className={`active:text-red-500 mr-3 ${selectedCategory === "Groceries" ? "text-red-500" : ""}`}
      ...
      <main className="p-4 px-16 flex justify-center items-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          {currentProducts.map((item) => (
            <div
              key={item.id}
              className="bg-white w-96 mx-auto md:w-56 lg:w-64 lg:mx-auto md:mx-auto rounded-lg shadow-lg hover:border-red-500 cursor-pointer relative border border-gray-300 transition-all duration-300 max-w-sm"
            >
              <img
                src={item.thumbnail}
                alt=""
