          ...
          <table className="w-full table-auto">
            <tbody>
              <tr className="flex flex-col md:flex-row gap-4 md:gap-6 bg-slate-50 rounded-lg p-4 md:p-6 shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                <td className="md:w-1/4 flex items-center gap-3 ml-10">
                  <IoIosLogOut onClick={handelLogOut} className="text-indigo-600 cursor-pointer hover:text-indigo-900 " size={20} />
                </td>
              </tr>
            </tbody>
          </table>
